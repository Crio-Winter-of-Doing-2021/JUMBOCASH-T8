...
class IncomeTransactionFilter(filters.FilterSet):
    trans_date_gt = filters.DateTimeFilter(
        field_name="trans_date_time", lookup_expr="gt"
    )
    trans_date_lt = filters.DateTimeFilter(
        field_name="trans_date_time", lookup_expr="lt"
    )
